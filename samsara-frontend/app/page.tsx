...
export default function Home() {
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-gold {
          font-family: 'TT Fors', 'Inter', sans-serif; font-size: var(--text-sm);
  ...
  /* ABOUT HERO SECTION */
        ...
        .marquee-item {
          ...
          color: var(--dark); font-family: 'TT Fors', 'Inter', sans-serif; font-weight: 400;
       ...
       /* TESTIMONIALS */
        ...
        .footer-logo-text { font-family: 'TT Fors', 'Inter', sans-serif; font-size: var(--text-md); font-weight: 300; letter-spacing: 0.25em; text-transform: uppercase; color: var(--gold-light); margin-bottom: 1.2rem; display: block; }
