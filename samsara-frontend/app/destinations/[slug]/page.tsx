    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .enquire-title { font-family: 'TT Fors', sans-serif; font-size: clamp(1.62rem, 4vw, 2.62rem); font-weight: 300; color: var(--white); margin-bottom: 1rem;  text-transform: uppercase; letter-spacing: 0.08em; }
        ...
        .more-name { font-family: 'TT Fors', sans-serif; font-size: 1.4rem; font-weight: 300; color: var(--white); }
        ...
        .footer-logo { font-family: 'TT Fors', sans-serif; font-size: var(--text-md); font-weight: 300; letter-spacing: 0.25em; text-transform: uppercase; color: var(--gold-light); margin-bottom: 1rem; display: block; }
      ...
      <section id="overview" className="overview">
        ...
        <h2 className="section-title">A Place That<br />Stays With You</h2>
      ...
      <section className="enquire-banner">
        <div>
          <h2 className="enquire-title">Ready to Discover<br />{dest.name}?</h2>
      ...
      <section className="more-dest">
        ...
        <h2 className="section-title">Discover More Destinations</h2>
